...
defmodule Ex1142 do
  ...
  defp print_lines(actual, stop) when actual > stop, do: nil

  defp print_lines(actual, stop) when rem(actual, 4) == 0 do
    IO.puts("PUM")
    print_lines(actual + 1, stop)
  end

  defp print_lines(actual, stop) do
    IO.write("#{actual} ")
    print_lines(actual + 1, stop)
  end
end
