...
calc_duration = fn start_time, end_time ->
  cond do
    start_time < end_time -> end_time - start_time
    true                  -> (end_time + 24) - start_time
  end
end

[st_time, end_time] = BcInput.input_as_integer_array

IO.puts("O JOGO DUROU #{calc_duration.(st_time, end_time)} HORA(S)")
